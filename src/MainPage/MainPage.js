...
const MainPage = ({select, closeCheck, setSelect, emptPage, setEmptPage}) => {
    ...
    return(
        <div className={closeCheck == true ? "MainPageMainDiv MainPageDiv2" :"MainPageMainDiv"}>
            ...
            select={select} appliedJob={appliedJob} emptPage={emptPage} setEmptPage={setEmptPage} setSelect={setSelect}/> : <div></div>)) : (
            ...
            <StudentApplied emptPage={emptPage} setEmptPage={setEmptPage} setSelect={setSelect}/>)) :
            (select == 0 ? 
